...
const StartLearning = () => {
  return (
    <div className='container mx-auto mt-[120px] pb-[158px] relative'>
      <div className='flex flex-col justify-center items-center h-[278px] rounded-[40px] border border-[#202020] bg-[rgba(0, 0, 0, 0.1)]'>
        <h4 className='text-[40px] leading-[45px] mb-2 font-dmSans font-bold'>
          Start learning now
        </h4>
