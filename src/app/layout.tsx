...
export const metadata: Metadata = {
  title:
    "Learn Node.js | 11-Week Comprehensive Course with Hands-On Projects & Expert Guidance",
  description:
  ...
  openGraph: {
    title:
      "Master Node.js in 11 Weeks | Live Classes, Quizzes, and Project-Based Learning",
    description:
  ...
  twitter: {
    title: "Learn Node.js in 11 Weeks | Hands-On Projects & Expert Guidance",
    description:
